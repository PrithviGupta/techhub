...
$conn = new PDO("mysql:host=localhost;dbname=techhub", 'root', '');		
//get action string
...
$con = new PDO("mysql:host=localhost;dbname=techhub",'root','');
	...
	if($row = $sth->fetch())
	{
      ...
      <th>Image</th>
        ...
        <th>Add to Cart</th>
			...
			<tr>
      <td><img src="<?php print $row->image?>" height="100px" width="150px"></td>
      <td><?php print $row->name?></td>
      <td>Rs<?php print $row->price?></td>
      <td>
      <form method="post" action="shopping-cart.php?action=addcart">
              <p style="text-align:center;color:#04B745;">
                ...
                <input type="hidden" name="sku" value="<?php print $row->sku?>">
              </p>
            </form>
  </td>
...
<div class="container" style="width:600px;">
  ...
  <table class="table table-striped">
    ...
    <tr>
      ...
      <td>Rs<?php print $product['price']?></td>
    ...
    <?php endforeach;?>
    <tr><td colspan="5" align="right"><h4>Total:Rs<?php print $total?></h4></td></tr>
  </table>
  <?php endif;?>
  ...
  <div class="row" style="height:100px;">
    <div class="container" style="width:600px;">
      ...
      <div class="col-md-4" style="width:150px,height:80px;" >
        <div class="thumbnail"> <img src="<?php print $product['image']?>" width="50px" height="50px">
          <div class="caption">
            <p style="text-align:center;"><?php print $product['name']?></p>
            <p style="text-align:center;color:#04B745;"><b>Rs<?php print $product['price']?></b></p>
            <form method="post" action="shopping-cart.php?action=addcart">
              <p style="text-align:center;color:#04B745;">
                <button id="checkoutButton" type="submit" class="btn btn-warning">Add To Cart</button>
